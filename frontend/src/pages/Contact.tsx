    ...
    <div className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h2 className="text-2xl font-bold text-heading-1 mb-8">
              ...
              {adminProfile?.location && (
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-body-var">{adminProfile.location}</p>
                  </div>
                </div>
              )}
            </div>
                  ...
                  {Object.entries(adminProfile.socialLinks)
                    ...
                    .map(([platform, url]) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 hover:border-gray-300 text-body-var hover-text-brand transition-all duration-300"
                      >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full flex items-center justify-center px-6 py-3 rounded-xl text-base font-medium btn-brand ${
